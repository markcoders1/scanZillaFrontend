            ...
            <>
                {parts.map((part, index) =>
                    index % 3 === 0 ? (
                        ...
                        <strong key={index}>{`${parts[index]}${parts[index + 1]}${parts[index]}`}</strong>
                    ) : null
                )}
            </>
        );
        ...
        return (
            <>
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    &nbsp;
                    {prirority == "high" || prirority == "medium" || prirority == "low" ? (
                        <Alert
                            variant="outlined"
                            sx={{
                                width: "fit-content",
                            ...
                            severity={prirority == "low" ? "info" : prirority == "medium" ? "warning" : "error"}
                        >
                            Severity : {prirority}
                        </Alert>
                    ) : (
            ...
            {isLoading ? (
                ...
                <>
                  ...
                  rules.titleCharacters ? console.log(rules.titleCharacters) : ""
                            ...
                            >
                                <Heading Heading="Bullet Points" creditText={"Credits"} creditUtilized={bulletPointsCredits} />
                                            ...
                                            {!data.title ? (
                                                ...
                                                >
                                                    ...
                                                    {AnalyzeErrros?.TE?.map((item, index) => (
                                                        ...
                                                        >
                                                            {/* {item.error} */}
                                                            {TextWithBlacklist(item.error, AnalyzeErrros.TE.length, index, item.error, item.priority)}
                                                        </Typography>
                                                    ))}
                                                </Paper>
                                            ) : (
                                            ...
                                            {!data.description ? (
                                                ...
                                                >
                                                    ...
                                                    {AnalyzeErrros?.DE?.map((item, index) => (
                                                        ...
                                                        >
                                                            {/* {item.error} */}
                                                            {TextWithBlacklist(item.error, AnalyzeErrros.DE.length, index, item.error, item.priority)}
                                                        </Typography>
                                                    ))}
                                                </Paper>
                                            ) : (
                                            ...
                                            {!data.keywords ? (
                                                ...
                                                >
                                                    ...
                                                    {AnalyzeErrros?.KE?.map((item, index) => (
                                                        ...
                                                        >
                                                            {/* {item.error} */}
                                                            {TextWithBlacklist(item.error, AnalyzeErrros.KE.length, index, item.error, item.priority)}
                                                        </Typography>
                                                    ))}
                                                </Paper>
                                            ) : (
